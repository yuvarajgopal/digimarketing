...
function GoogleAdsSvg({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M3.2 12 8 3.6l9.6 16.8H8L3.2 12Zm17.6 8.4L16 12l4.8-8.4c1.6 2.8 1.6 6.4 0 8.4l-4 7.2c-.4.8-.4 1.6 0 1.2Zm-8-8.4 4.8 8.4H8l4.8-8.4Z" />
    </svg>
  );
}

function PinterestSvg({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
const platformSvgMap: Record<Platform, React.FC<{ className?: string }>> = {
  FACEBOOK: FacebookSvg,
  INSTAGRAM: InstagramSvg,
  GOOGLE_ADS: GoogleAdsSvg,
  YOUTUBE: YouTubeSvg,
...
export function PlatformIcon({ platform, size = "md", showLabel = false, className }: PlatformIconProps) {
  ...
  const SvgIcon = platformSvgMap[platform];
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      >
        <SvgIcon className={iconSizeClasses[size]} />
      </div>
